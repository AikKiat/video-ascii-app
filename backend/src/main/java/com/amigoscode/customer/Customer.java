...
@Table(
        ...
        uniqueConstraints = {
                ...
                @UniqueConstraint(
                        ...
                        columnNames = "profileImageId" //tallies with the signature of the private String variable profileImageId
                )
        }
)
public class Customer implements UserDetails {
    ...
    //Defining different constructors for each input combination
    ...
    public Customer(Integer id,
        ...
        this(id, name, email, password, age, gender); //use the already predefined constructor above to achieve this shorthand.
