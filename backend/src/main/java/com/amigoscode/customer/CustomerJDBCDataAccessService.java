...
public class CustomerJDBCDataAccessService implements CustomerDao {
    ...
    public void updateCustomerProfileImageId(String profileImageId, Integer customerId){
        //write SQL to update the profile image
        var sql = """
                UPDATE CUSTOMER
                SET profile_image_id = ? /*Corresponds to first argument in *args under jdbcTemplate.update() --> profileImageId*/
                WHERE id = ? /*Second argument in *args under jdbcTemplate.update() --> customerId*/
                """;
